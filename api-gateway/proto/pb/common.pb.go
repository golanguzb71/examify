...
type User struct {
	...
	Surname        string `protobuf:"bytes,3,opt,name=surname,proto3" json:"surname"`
	...
	ChatId         string `protobuf:"bytes,6,opt,name=chatId,proto3" json:"chatId"`
	TodayExamCount int32  `protobuf:"varint,7,opt,name=todayExamCount,proto3" json:"todayExamCount"`
}
...
func (x *User) GetTodayExamCount() int32 {
	if x != nil {
		return x.TodayExamCount
	}
	return 0
}
...
var file_common_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xba,
	...
	0x74, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0e, 0x74, 0x6f, 0x64, 0x61, 0x79, 0x45, 0x78, 0x61, 0x6d,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x74, 0x6f, 0x64,
	0x61, 0x79, 0x45, 0x78, 0x61, 0x6d, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x0c, 0x5a, 0x0a, 0x2e,
