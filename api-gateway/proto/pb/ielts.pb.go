...
type CreateOutlineAttemptRequestSpeaking struct {
	...
	ExamId     string                        `protobuf:"bytes,1,opt,name=examId,proto3" json:"examId"`
	Qua        []*QuestionUserAnswerSpeaking `protobuf:"bytes,2,rep,name=Qua,proto3" json:"Qua"`
	PartNumber int32                         `protobuf:"varint,3,opt,name=partNumber,proto3" json:"partNumber"`
}
...
type QuestionUserAnswerSpeaking struct {
	...
	Question    string `protobuf:"bytes,1,opt,name=question,proto3" json:"question"`
	VoiceAnswer []byte `protobuf:"bytes,2,opt,name=voiceAnswer,proto3" json:"voiceAnswer"`
}
