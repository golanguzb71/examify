...
type GetBonusInformationByChatIdResponse struct {
	...
	WelcomeCount int32                      `protobuf:"varint,3,opt,name=welcomeCount,proto3" json:"welcomeCount,omitempty"`
	BonusCount   int32                      `protobuf:"varint,4,opt,name=bonusCount,proto3" json:"bonusCount,omitempty"`
	RegisteredAt string                     `protobuf:"bytes,5,opt,name=registeredAt,proto3" json:"registeredAt,omitempty"`
	More         []*GetMoreBonusInformation `protobuf:"bytes,6,rep,name=more,proto3" json:"more,omitempty"`
}
...
type GetMoreBonusInformation struct {
	...
	GuestName         string `protobuf:"bytes,1,opt,name=guestName,proto3" json:"guestName,omitempty"`
	GuestChatId       string `protobuf:"bytes,2,opt,name=guestChatId,proto3" json:"guestChatId,omitempty"`
	GuestRegisteredAt string `protobuf:"bytes,3,opt,name=guestRegisteredAt,proto3" json:"guestRegisteredAt,omitempty"`
}
